...
13. Roggvir's execution scene, the first time you enter Solitude, has a reported issue that causes all NPCs who witness the scene getting into a hung state even after they leave the area. The bug is that they will only give you dialogue related to the execution, even though they're back in their daily locations--and if the NPC is a merchant, this will also block you from doing transactions with them! This is now on Ouroboros' radar so you don't need to report it separately. Until he's able to deliver a fix, a known workaround for this is to simply let the scene play out fully before _you_ leave the area. Wait for Ahtar the executioner to deliver the line "That makes twenty-three." Once he says that, then you're good to go about your business.
</details>
---
edit_uri: https://github.com/Omni-guides/Tuxborn/wiki/Spells-available-in-Tuxborn
---
...
* [Apocalypse - Magic of Skyrim](https://www.nexusmods.com/skyrimspecialedition/mods/1090) - The Enairim mod for spells
* [Mysticism - A Magic Overhaul](https://www.nexusmods.com/skyrimspecialedition/mods/27839) - The Simonrim mod for spells
...
More information can be found about this on the [Ascension](https://www.nexusmods.com/skyrimspecialedition/mods/89223) page on Nexus. Ascension is a patch for Adamant also by Darenii, which hooks use of those perks into the Adamant skill tree design.
...
* Falskaar
* [Gravewind](https://www.nexusmods.com/skyrimspecialedition/mods/129582) - Adds several new spells, detailed on the mod's Nexus page
...
Of particular interest: both Project AHO and Wyrmstooth include Cure Disease spells, and these _can_ work to cure the Death's Grip debuff from Shades of Mortality. The two spells are _not_ identical; in theory, Project AHO's version can also cure diseases on allies as well as the player. Practically speaking, however, your followers are not likely to need this.
...
Additional notes:
1. Most, but not _all_, general good merchants will often have random Novice spells for sale as well, but this is mostly useful only in the early stages of a playthrough. It's worth checking the general good merchants, though, if you're in search of something basic like Candlelight or Oakflesh. See above list for which specific general goods merchants have spells.
2. The court mages and the College of Winterhold trainers have a wider variety of spells available thanks to Apocalypse and Mysticism. But the court mages have a less comprehensive assortment than the College of Winterhold trainers do. Court wizards will generally have a complete set of Novice and Apprentice spells, plus Adept spells in whatever school of magic they're proficient in (see names above for what schools they specialize in). The Adept spells however will be present in their lists _only_ if you're leveled up high enough in that specific skill. Also, not all schools of magic are represented by the court mages. So for best variety, and for access to higher-level spells, go buy spells from the College trainers.
3. College of Winterhold trainers will have _leveled_ lists, so you will only see them sell higher tier spells once you have leveled up the relevant school of magic enough to use the spells in question. So if you really want a higher level spell earlier, you may need to take alternate steps to get access to that spell, such as running Project AHO so that you can get access to the Typewriter.   
...
* [Arcane Accessories](https://en.uesp.net/wiki/Skyrim:Arcane_Accessories): Adds a chest halfway through Hob's Fall Keep that contains several additional spells
* [Arcane Archer Pack](https://en.uesp.net/wiki/Skyrim:Arcane_Archer_Pack): Adds Bound Quiver and Telekinesis Arrow spells
* [Forgotten Seasons](https://en.uesp.net/wiki/Skyrim:Forgotten_Seasons): Adds Turn of the Seasons spell that has different effects based on weather
* [Necromantic Grimoire](https://en.uesp.net/wiki/Skyrim:Necromantic_Grimoire): Adds several additional Conjuration spells that can be purchased from Phinis at the College of Winterhold
* [Pets of Skyrim](https://en.uesp.net/wiki/Skyrim:Pets_of_Skyrim): Adds summon spells for any pets you adopt via this Creation
* [Plague of the Dead](https://en.uesp.net/wiki/Skyrim:Plague_of_the_Dead): Adds four spells to conjure various types of zombie, which can either be found at the ritual site for the quest for this Creation, or purchased later from vendors
* [Saints & Seducers](https://en.uesp.net/wiki/Skyrim:Saints_%26_Seducers): Assorted summon spells that cover the daedra types in this Creation, including a spell to summon Staada
* [The Cause](https://en.uesp.net/wiki/Skyrim:The_Cause): Includes a spell to summon a Daedric Horse (renamed to Nightmare Courser in our load order)
